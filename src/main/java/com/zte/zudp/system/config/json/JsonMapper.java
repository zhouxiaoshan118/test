...
public class JsonMapper extends ObjectMapper {
    ...
    public JsonMapper(JsonInclude.Include include) {
        ...
        // 允许单引号、允许不带引号的字段名称
        this.enableSimple();
        // 一个双向开关，开启将输出没有JsonView注解的属性，false关闭将输出有JsonView注解的属性
    ...
    /**
     * 创建只输出非 Null且非 Empty(如List.isEmpty) 的属性到 Json 字符串的 Mapper ,建议在外部接口中使用.
     */
    ...
    /**
     * 当 json 里只含有 bean 的部分属性时，更新一个已存在的 bean，只覆盖该部分的属性
     */
    @SuppressWarnings("unchecked")
