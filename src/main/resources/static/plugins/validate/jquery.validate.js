...
$.extend( $.validator, {
	...
	messages: {
		...
		checkAccount:"6~18 characters, you can use letters, numbers, to underline, beginning with the letter",
		verifyAccount:"Account has been used",
		verifySysAccount:"6~6 characters, you can use letters, numbers, to underline, beginning with the letter",
		isMobile: "Please enter the mobile.",
		verifyMoible:"Mobile has been used",
		checkImei:"Please check the device number and re enter",
		isIdCardNo:"Invalid ID number",
	...
	methods: {
		...
		//检查账号格式
		checkAccount:function (value, element, param) {
			var pattern = /^[a-zA-z]\w{6,15}$/;
